...
What is the minimal set of use cases that should be supported for version 1.0.0? What is considered acceptable and useful and what would be regarded as malfunctioning piece of junk that completely wastes the users time? 
